...
const getPathList = (t: ContextApi['t']): PathList => {
  return {
    paths: {
      ...
      '/info': { title: t('Overview'), description: 'View statistics for OvenSwap exchanges.' },
      '/info/pools': { title: t('Pools'), description: 'View statistics for OvenSwap exchanges.' },
      '/info/tokens': { title: t('Tokens'), description: 'View statistics for OvenSwap exchanges.' },
      '/nfts/collections': { basePath: true, title: t('Collections') },
      '/nfts/activity': { title: t('Activity') },
      '/profile': { basePath: true, title: t('Profile') },
      '/pancake-squad': { basePath: true, title: t('OvenSwap Squad') },
      '/pottery': { basePath: true, title: t('Pottery') },
    },
    defaultTitleSuffix: t('Oven-Swap'),
  }
}
